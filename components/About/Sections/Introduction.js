  ...
  return (
    <>
      {IntroDetails?.data?.map((data, i) => {
        return (
          <Row className="m-0 align-items-center AboutInfoCN" key={i}>
            <Col lg="5" className="p-0 order-res-2">
              <div className="AboutIntroInfo">
                <div className="AboutIntroTitle">{t("alaminCompany")}</div>
                <div className="AboutIntroDescription">{data.introduction}</div>
              </div>
            </Col>
            <Col lg="1" className="p-0"></Col>
            <Col lg="6" className="p-0 order-res-1">
              <div className="AboutIntroImg">
                <Image loading="eager" width={300} height={300} src={"/assets/static/about-intro.png"} alt="Intro" loader={imageLoader}/>
              </div>
            </Col>
          </Row>
        );
